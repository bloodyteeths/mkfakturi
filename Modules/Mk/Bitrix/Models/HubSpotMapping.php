 ...
 */
class HubSpotMapping extends Model
{
    use HasFactory;
    ...
    /**
     * Find a mapping by HubSpot company ID.
     *
     * @param string $companyId
     * @return static|null
     */
    public static function findByCompanyId(string $companyId): ?static
    {
        return static::where('hubspot_company_id', $companyId)->first();
    }
     ...
     * @return bool
     */
    public static function updateDealStage(string $email, string $stage): bool
    {
        $mapping = static::findByEmail($email);
    ...
    /**
     * Set deal stage on this mapping.
     *
     * @param string $stage Deal stage
     * @return bool
     */
    public function setDealStage(string $stage): bool
    {
        return $this->update([
            'deal_stage' => $stage,
            'last_synced_at' => now(),
    ...
    /**
     * Scope a query to only include mappings with a HubSpot company.
     *
     * @param \Illuminate\Database\Eloquent\Builder $query
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeHasCompany($query)
    {
