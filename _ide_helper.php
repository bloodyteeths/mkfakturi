...
{
            return \Lavary\Menu\Collection::debug();
        }
...
{
            return \Lavary\Menu\Collection::downloadExcel($fileName, $writerType, $withHeadings, $responseHeaders);
        }
...
{
            return \Lavary\Menu\Collection::storeExcel($filePath, $disk, $writerType, $withHeadings);
        }
        ...
        public static function debug()
{
        ...
        public static function downloadExcel($fileName, $writerType = null, $withHeadings = false, $responseHeaders = [])
{
            return \Spatie\MediaLibrary\MediaCollections\Models\Collections\MediaCollection::downloadExcel($fileName, $writerType, $withHeadings, $responseHeaders);
        }
        ...
        public static function storeExcel($filePath, $disk = null, $writerType = null, $withHeadings = false)
{
            return \Spatie\MediaLibrary\MediaCollections\Models\Collections\MediaCollection::storeExcel($filePath, $disk, $writerType, $withHeadings);
        }
    ...
    class TaggedCache
{
         ...
         * 
         *
         * @see \App\Providers\CacheServiceProvider::configureCacheSettings()
         * @param mixed $key
         * @param mixed $ttl
         * @param mixed $callback
         * @static 
         */
        public static function companyRemember($key, $ttl, $callback)
{
            return \Illuminate\Cache\TaggedCache::companyRemember($key, $ttl, $callback);
        }
         ...
         * @static 
         */
        public static function userRemember($key, $ttl, $callback)
{
            return \Illuminate\Cache\TaggedCache::userRemember($key, $ttl, $callback);
        }
         ...
         * @static 
         */
        public static function modelRemember($model, $key, $ttl, $callback)
{
            return \Illuminate\Cache\TaggedCache::modelRemember($model, $key, $ttl, $callback);
        }
         ...
         * @static 
         */
        public static function apiRemember($request, $ttl, $callback)
{
            return \Illuminate\Cache\TaggedCache::apiRemember($request, $ttl, $callback);
        }

        /**
         * 
         *
         * @see \App\Providers\CacheServiceProvider::registerCacheMacros()
         * @param mixed $companyId
         * @static 
         */
        public static function flushCompanyCache($companyId = null)
{
            return \Illuminate\Cache\TaggedCache::flushCompanyCache($companyId);
        }
         ...
         * @static 
         */
        public static function flushModelCache($model)
{
            return \Illuminate\Cache\TaggedCache::flushModelCache($model);
        }
...
{
            return \Illuminate\Cache\TaggedCache::getStats();
        }
    ...
    class Repository
{
        ...
        public static function companyRemember($key, $ttl, $callback)
{
            return \Illuminate\Cache\Repository::companyRemember($key, $ttl, $callback);
        }
        ...
        public static function userRemember($key, $ttl, $callback)
{
            return \Illuminate\Cache\Repository::userRemember($key, $ttl, $callback);
        }
        ...
        public static function modelRemember($model, $key, $ttl, $callback)
{
            return \Illuminate\Cache\Repository::modelRemember($model, $key, $ttl, $callback);
        }
        ...
        public static function apiRemember($request, $ttl, $callback)
{
            return \Illuminate\Cache\Repository::apiRemember($request, $ttl, $callback);
        }
        ...
        public static function flushCompanyCache($companyId = null)
{
            return \Illuminate\Cache\Repository::flushCompanyCache($companyId);
        }
        ...
        public static function flushModelCache($model)
{
            return \Illuminate\Cache\Repository::flushModelCache($model);
        }
        ...
        public static function getStats()
{
            return \Illuminate\Cache\Repository::getStats();
        }
