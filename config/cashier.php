...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can override Cashier's default Eloquent models with your own.
    | This is used to customize table names to avoid conflicts with
    | InvoiceShelf's existing tables (customers, transactions, etc.).
    |
    */

    'customer_model' => \App\Models\PaddleCustomer::class,
    'subscription_model' => \App\Models\PaddleSubscription::class,
    'subscription_item_model' => \App\Models\PaddleSubscriptionItem::class,
