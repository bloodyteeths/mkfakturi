...
return [
    ...
    */
    'table_names' => [
         ...
         */
        'categories' => 'ticket_categories', // CLAUDE-CHECKPOINT: Renamed to avoid conflict with existing categories table
        /**
         * Labels table for the tickets
         */
        'labels' => 'ticket_labels', // CLAUDE-CHECKPOINT: Renamed for consistency
        /**
