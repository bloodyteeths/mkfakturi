...
return [
    ...
    */
    'main_menu' => [
        ...
        [
            'title' => 'partner.console.home',
            'group' => 'partner.console',
            'link' => '/admin/console',
            'icon' => 'HomeIcon',
            'name' => 'partner.console.home',
            'owner_only' => false,
            'ability' => '',
            'model' => '',
        ],
        [
            'title' => 'partner.console.commissions',
            'group' => 'partner.console',
            'link' => '/admin/console/commissions',
            'icon' => 'CurrencyDollarIcon',
            'name' => 'partner.console.commissions',
            'owner_only' => false,
            'ability' => '',
            'model' => '',
        ],
        [
            'title' => 'partner.console.invite_company',
            'group' => 'partner.console',
            'link' => '/admin/console/invite-company',
            'icon' => 'BuildingOfficeIcon',
            'name' => 'partner.console.invite-company',
            'owner_only' => false,
            'ability' => '',
            'model' => '',
        ],
        [
            'title' => 'partner.console.invite_partner',
            'group' => 'partner.console',
            'link' => '/admin/console/invite-partner',
            'icon' => 'UserGroupIcon',
            'name' => 'partner.console.invite-partner',
            'owner_only' => false,
            'ability' => '',
            'model' => '',
        ],
        [
            'title' => 'partner.console.invitations',
            'group' => 'partner.console',
            'link' => '/admin/console/invitations',
            'icon' => 'EnvelopeIcon',
            'name' => 'partner.console.invitations',
            'owner_only' => false,
            'ability' => '',
            'model' => '',
        ],
