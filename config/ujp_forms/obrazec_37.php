...
return [
    ...
    */
    'account_code_to_aop' => [
        ...
        // 72x — Продажба во земјата → AOP 202
        '720' => '202', // Производи
        '721' => '202', // Услуги
        '722' => '202', // Стока

        // 73x — Продажба во странство → AOP 202
        '730' => '202', // Производи
        '731' => '202', // Услуги
        '732' => '202', // Стока

        // 74x — Промени на залихи
        '740' => '203', // Зголемување на залихи → Останати приходи
        '741' => '212', // Намалување на залихи → Останати трошоци (expense)
        '742' => '203', // Зголемување на недовршено → Останати приходи
        '743' => '212', // Намалување на недовршено → Останати трошоци (expense)
