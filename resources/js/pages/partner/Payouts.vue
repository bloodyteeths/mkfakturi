      ...
      <div class="p-6">
        ...
        <div v-else-if="stripeConnect.status === 'disabled'" class="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-6">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-grow">
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Сметката е деактивирана</h3>
              <p class="text-gray-600 mb-4">
                Вашата Stripe сметка е деактивирана. Треба да ги завршите потребните чекори за да ја активирате.
              </p>
              ...
              >
                ...
                {{ onboardingLoading ? 'Се вчитува...' : 'Активирај сметка' }}
              </button>
            </div>
          </div>
        </div>
