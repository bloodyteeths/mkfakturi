<template>
  <div class="success-page min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
      ...
      <!-- Message -->
      <h1 class="text-3xl font-bold text-gray-900 mb-4">Welcome to Facturino!</h1>
