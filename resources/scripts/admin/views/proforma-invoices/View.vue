  ...
  <BasePage v-if="proformaInvoiceData" class="xl:pl-96 xl:ml-8">
    ...
    <BaseCard class="mt-8">
      <BaseTabGroup>
        ...
        <!-- Email History Tab -->
        <BaseTab
          v-if="proformaInvoiceData.email_logs?.length"
          tab-panel-container="py-4 mt-px"
          :title="`${$t('general.email_history')} (${proformaInvoiceData.email_logs.length})`"
        >
          <div class="p-4 space-y-3">
            <div
              v-for="log in proformaInvoiceData.email_logs"
              :key="log.id"
