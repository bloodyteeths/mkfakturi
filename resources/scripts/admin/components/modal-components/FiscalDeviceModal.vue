    ...
    <form action="" @submit.prevent="submitData">
      <div class="p-4 sm:p-6">
        <BaseInputGrid layout="one-column">
          ...
          <BaseInputGroup
            v-if="fiscalDeviceStore.currentFiscalDevice.connection_type === 'tcp'"
          ...
          <BaseInputGroup
            v-if="fiscalDeviceStore.currentFiscalDevice.connection_type === 'serial' || fiscalDeviceStore.currentFiscalDevice.connection_type === 'bluetooth'"
