...
const pageHeading = computed(() => {
  ...
  return 'Едноставно фактурирање за поединци и мали бизниси'
})
...
const pageDescription = computed(() => {
  ...
  return 'Факторино ви помага да ги следите трошоците, да евидентирате плаќања и да создавате убави фактури и проценки.'
})
