...
<p>@lang('outreach.followup4.final')</p>

<p>@lang('outreach.followup4.if_yes')</p>

<p>@lang('outreach.followup4.if_no')</p>

<p><a href="{{ $signupUrl }}" style="color: #1a73e8; font-weight: bold; font-size: 16px; text-decoration: underline;">@lang('outreach.followup4.cta') &rarr;</a></p>

<p><em>@lang('outreach.followup4.fomo')</em></p>
