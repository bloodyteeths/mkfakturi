...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Facturino">
...
<body
    ...
    @if(isset($current_theme)) theme-{{ $current_theme }} @else theme-{{get_app_setting('admin_portal_theme') ?? 'facturino'}} @endif ">
