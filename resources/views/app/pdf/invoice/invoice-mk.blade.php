...
<body>
    ...
    <div class="info-grid">
        ...
        <div class="info-col" style="border-right: 1px solid #ccc;">
            ...
            @php
                $bankAccount = $bank_account ?? ($invoice->company->bank_account_number ?? data_get($invoice->company, 'settings.bank_account_number'));
    ...
    <table style="width:100%; margin-bottom:6px; border-collapse:collapse;">
        ...
        <tr>
            ...
            <td style="padding:3px; border:1px solid #333;">{{ $invoice->formattedPerformanceDate ?? $invoice->formattedInvoiceDate }}</td>
    ...
    <div style="margin-top: 6px; padding: 4px; border: 1px solid #ccc; font-size: 9px;">
        ...
        @php
            $payBankAccount = $bank_account ?? ($bankAccount ?? ($invoice->company->bank_account_number ?? data_get($invoice->company, 'settings.bank_account_number')));
