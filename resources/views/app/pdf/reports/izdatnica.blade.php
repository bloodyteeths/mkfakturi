...
<head>
    <title>Издатница бр. {{ $document['document_number'] ?? '' }}</title>
    <style type="text/css">
        body {
...
<body>
    ...
    <p class="heading-text">ИЗДАТНИЦА</p>
    <p class="sub-heading">Издавање на стоки и материјали од магацин</p>

    {{-- Document Info --}}
    <table class="doc-info">
        <tr>
            <td class="label">Издатница бр.:</td>
    ...
    <p class="form-ref">Издатница — Магацински документ / Правилник за евиденции (Сл. весник 51/04)</p>

    {{-- Signatures --}}
    <table class="signature-section">
        <tr>
            <td style="width: 33%; text-align: center; padding-top: 40px;">
                <p class="signature-label">Издал</p>
            </td>
            <td style="width: 33%; text-align: center; padding-top: 40px;">
