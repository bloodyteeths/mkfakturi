...
<html lang="mk">
<head>
    <title>Приемница {{ $document_number }}</title>
    <style type="text/css">
        body {
...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="value">{{ $warehouse_name }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="value">Прием од производство</td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td class="value">{{ $reference_document ?? '—' }}</td>
        </tr>
        @endif
    ...
    {{-- Items Table (8 columns per Правилник Сл. весник 51/04) --}}
