...
<head>
    <title>Преносница бр. {{ $document['document_number'] ?? '' }}</title>
    <style type="text/css">
        body {
...
<body>
    ...
    <p class="heading-text">ПРЕНОСНИЦА</p>
    <p class="sub-heading">Пренос на стоки и материјали меѓу магацини</p>

    {{-- Document Info --}}
    <table class="doc-info">
        <tr>
            <td class="label">Преносница бр.:</td>
        ...
        <tr>
            ...
            <td class="value"><strong>{{ $document['from_warehouse'] ?? '' }}</strong></td>
            <td class="label">Во магацин:</td>
            <td class="value"><strong>{{ $document['to_warehouse'] ?? '' }}</strong></td>
        </tr>
        @if(isset($document['reason']))
        <tr>
            <td class="label">Основ:</td>
            <td class="value" colspan="3">{{ $document['reason'] }}</td>
        </tr>
        @endif
    </table>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 13%;">
                    Вредност
                    <span class="col-header-sub">7 (5×6)</span>
                </th>
                <th style="width: 12%;">
                    Забелешка
    ...
    <p class="form-ref">Преносница — Интерен магацински документ / Правилник за евиденции (Сл. весник 51/04)</p>

    {{-- Signatures --}}
    <table class="signature-section">
        <tr>
            <td style="width: 33%; text-align: center; padding-top: 40px;">
                <p class="signature-label">Испратил</p>
            </td>
            <td style="width: 33%; text-align: center; padding-top: 40px;">
