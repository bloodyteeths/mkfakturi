    ...
    <div class="content-wrapper">
        <div style="padding-top: 30px">
            <div class="company-address-container">
                ...
                @if(isset($bill->company->vat_id) && $bill->company->vat_id)
                    <div style="margin-top: 5px; font-size: 11px;"><strong>ЕДБ за ДДВ:</strong> {{ $bill->company->vat_id }}</div>
                @endif
                @if(isset($bill->company->tax_id) && $bill->company->tax_id)
                    <div style="margin-top: 3px; font-size: 11px;"><strong>Даночен број:</strong> {{ $bill->company->tax_id }}</div>
                @endif
            </div>
            ...
            <div class="invoice-details-container">
                <table>
                    <tr>
                        ...
                        <td class="attribute-value"> &nbsp;{{ $bill->bill_number }}</td>
                    </tr>
                    <tr>
