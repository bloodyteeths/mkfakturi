...
/**
 * Ohridska Banka CSV Parser
 *
 * Parses CSV exports from Ohridska Banka AD Ohrid (Охридска Банка).
 * Market share: ~1.9%
 *
 * CSV Format:
 * - Delimiter: Semicolon (;)
 ...
 */
class OhridskaCsvParser extends AbstractCsvParser
{
    ...
    public function canParse(string $content): bool
    {
        ...
        $markers = ['ohridska', 'охридска', 'ohridska banka', 'охридскабанка'];
        $markerCount = 0;
