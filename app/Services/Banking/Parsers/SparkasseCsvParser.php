...
/**
 * Sparkasse Banka CSV Parser
 *
 * Parses CSV exports from Sparkasse Banka AD Skopje (Шпаркасе Банка).
 * Market share: ~12.7%
 *
 * CSV Format:
 * - Delimiter: Semicolon (;)
 ...
 * - Датум на книжење (Booking Date)
 * - Датум на вредност (Value Date)
 * - Задолжување (Debit)
 * - Одобрување (Credit)
 * - Опис на трансакција (Description)
 * - Број на документ (Reference)
 * - Назив на комитент (Counterparty Name)
 * - Сметка на комитент (Counterparty Account)
 * - Валута (Currency)
 */
class SparkasseCsvParser extends AbstractCsvParser
{
    ...
    public function canParse(string $content): bool
    {
        ...
        $markers = ['sparkasse', 'шпаркасе', 'sparkasse banka', 'шпаркасебанка'];
        $markerCount = 0;
