...
/**
 * TTK Banka CSV Parser
 *
 * Parses CSV exports from TTK Banka AD Skopje (ТТК Банка).
 * Market share: ~3.8%
 *
 * CSV Format:
 * - Delimiter: Semicolon (;)
 ...
 */
class TtkCsvParser extends AbstractCsvParser
{
    ...
    public function canParse(string $content): bool
    {
        ...
        $markers = ['ttk', 'ттк', 'ttk banka', 'тткбанка'];
        $markerCount = 0;
