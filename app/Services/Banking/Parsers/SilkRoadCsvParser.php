...
/**
 * Silk Road Banka CSV Parser
 *
 * Parses CSV exports from Silk Road Banka AD Skopje (Силк Роуд Банка).
 * Market share: ~2.1%
 *
 * CSV Format:
 * - Delimiter: Semicolon (;)
 ...
 */
class SilkRoadCsvParser extends AbstractCsvParser
{
    ...
    public function canParse(string $content): bool
    {
        ...
        $markers = ['silk road', 'силкроуд', 'silkroad', 'silk road banka', 'силкроудбанка'];
        $markerCount = 0;
