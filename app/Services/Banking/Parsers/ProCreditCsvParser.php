...
/**
 * ProCredit Banka CSV Parser
 *
 * Parses CSV exports from ProCredit Banka AD Skopje (ПроКредит Банка).
 * Market share: ~5.2%
 *
 * CSV Format:
 * - Delimiter: Comma (,)
 ...
 */
class ProCreditCsvParser extends AbstractCsvParser
{
    ...
    public function canParse(string $content): bool
    {
        ...
        $markers = ['procredit', 'прокредит', 'pro credit', 'прокредитбанка'];
        $markerCount = 0;
        ...
        return $markerCount >= 1 && $commaCount >= 3;
    }
