...
class DatabaseConfigurationController extends Controller
{
    ...
    public function saveDatabaseEnvironment(DatabaseEnvironmentRequest $request)
    {
        ...
        \Log::info('DatabaseConfigurationController: Environment manager result', $results);

        if (array_key_exists('success', $results)) {
            \Log::info('DatabaseConfigurationController: Running migrations and setup');
            ...
            \Log::info('DatabaseConfigurationController: Setup completed successfully');
        }
