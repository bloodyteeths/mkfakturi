...
/**
 * Retry #2: create the 14 journal entries for ДЕМИРОВИЌ КОМПАНИ (entity 48).
 *
 * Previous attempts failed because:
 * 1. Missing exchange_rate_id (NOT NULL FK constraint)
 * 2. User entity_id was null → EntityScope filtered out lineItems → "must have at least one LineItem"
 * 3. Opening balance date 2026-01-01 = first day of reporting period → IFRS rejects it
 *
 * Fixes: set user entity_id=48 temporarily, include exchange_rate_id, shift Jan 1 to Jan 2.
 */
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Idempotency
        if (DB::table('ifrs_transactions')->where('entity_id', $entity->id)->count() > 0) {
            return;
        }
        ...
        $nalozi = [
            ...
            ['11-0001', '31-01-2026', [
                ['1001', '02-01-2026', 0, '1', 0, 1250, ''], ['4460', '02-01-2026', 0, '1', 1250, 0, ''],
                ['1001', '09-01-2026', 0, '2', 0, 150, ''], ['4460', '09-01-2026', 0, '2', 150, 0, ''],
                ['1001', '12-01-2026', 0, '3', 0, 2122, ''], ['2200', '12-01-2026', 44, '3', 2122, 0, ''],
                ['1001', '20-01-2026', 0, '4', 0, 10, ''], ['4460', '20-01-2026', 0, '4', 10, 0, ''],
                ['1001', '26-01-2026', 0, '5', 0, 1000, ''], ['1620', '26-01-2026', 16, '5', 1000, 0, '5'],
                ['1001', '31-01-2026', 0, '6', 0, 10, ''], ['4460', '31-01-2026', 0, '6', 10, 0, ''],
            ]],
            ['11-0002', '28-02-2026', [
                ['1001', '02-02-2026', 0, '7', 300000, 450, ''], ['4460', '02-02-2026', 0, '7', 450, 0, ''],
                ['1200', '02-02-2026', 99, '7', 0, 300000, '00001-26'],
                ['1001', '03-02-2026', 0, '8', 2500, 301015, ''],
                ['2401', '03-02-2026', 0, '8', 179400, 0, ''], ['2340', '03-02-2026', 0, '8', 12924, 0, ''],
                ['2341', '03-02-2026', 0, '8', 56591, 0, ''], ['2342', '03-02-2026', 0, '8', 22579, 0, ''],
                ['2343', '03-02-2026', 0, '8', 1506, 0, ''], ['2344', '03-02-2026', 0, '8', 3615, 0, ''],
                ['1009', '03-02-2026', 0, '8', 0, 2500, ''], ['2401', '03-02-2026', 0, '8', 24400, 0, ''],
                ['1001', '10-02-2026', 0, '9', 0, 920, ''], ['4460', '10-02-2026', 0, '9', 920, 0, ''],
                ['1001', '12-02-2026', 0, '10', 240176, 0, ''], ['1200', '12-02-2026', 99, '10', 0, 240176, '00001-26'],
                ['1001', '18-02-2026', 0, '11', 331149, 0, ''], ['1200', '18-02-2026', 99, '11', 0, 331149, ''],
                ['1001', '20-02-2026', 0, '12', 0, 20, ''], ['4460', '20-02-2026', 0, '12', 20, 0, ''],
                ['1001', '27-02-2026', 0, '13', 245000, 0, ''], ['1200', '27-02-2026', 132, '13', 0, 245000, ''],
                ['1001', '28-02-2026', 0, '14', 0, 10, ''], ['4460', '28-02-2026', 0, '14', 10, 0, ''],
            ]],
            ['11-0003', '31-03-2026', [
                ['1001', '01-03-2026', 0, '15', 0, 1250, ''], ['4460', '01-03-2026', 0, '15', 1250, 0, ''],
                ['1001', '02-03-2026', 0, '16', 0, 311015, ''],
                ['2401', '02-03-2026', 0, '16', 203800, 0, ''], ['2340', '02-03-2026', 0, '16', 12924, 0, ''],
                ['2341', '02-03-2026', 0, '16', 56591, 0, ''], ['2342', '02-03-2026', 0, '16', 22579, 0, ''],
                ['2343', '02-03-2026', 0, '16', 1506, 0, ''], ['2344', '02-03-2026', 0, '16', 3615, 0, ''],
                ['2200', '02-03-2026', 38, '16', 10000, 0, ''],
                ['1001', '03-03-2026', 0, '17', 116000, 0, ''], ['1620', '03-03-2026', 51, '17', 0, 116000, ''],
                ['1001', '04-03-2026', 0, '18', 0, 560000, ''], ['2200', '04-03-2026', 76, '18', 560000, 0, ''],
            ]],
            ['20-0001', '28-02-2026', [
                ['2200', '18-02-2026', 76, '000209/26', 0, 245000, '000209/26'],
                ['1300', '18-02-2026', 0, '000209/26', 37373, 0, ''], ['3100', '18-02-2026', 0, '000209/26', 207627, 0, ''],
            ]],
            ['21-0001', '31-01-2026', [
                ['2200', '24-01-2026', 38, '00003-26', 0, 10000, '00003-26'],
                ['1300', '24-01-2026', 0, '00003-26', 1525, 0, ''], ['44902', '24-01-2026', 0, '00003-26', 8475, 0, ''],
                ['2200', '02-01-2026', 44, '108479156444', 0, 2122, '108479156444'],
                ['1300', '02-01-2026', 0, '108479156444', 324, 0, ''], ['4111', '02-01-2026', 0, '108479156444', 1798, 0, ''],
                ['2200', '31-01-2026', 44, '108543091084', 0, 2191, '108543091084'],
                ['1300', '31-01-2026', 0, '108543091084', 334, 0, ''], ['4111', '31-01-2026', 0, '108543091084', 1857, 0, ''],
            ]],
            ['21-0002', '28-02-2026', [
                ['2200', '10-02-2026', 131, '200478', 0, 135000, '200478'],
                ['1300', '10-02-2026', 0, '200478', 20593, 0, ''], ['013031', '10-02-2026', 0, '200478', 114407, 0, ''],
                ['2200', '03-02-2026', 38, '00054-26', 0, 13600, '00054-26'],
                ['1300', '03-02-2026', 0, '00054-26', 1525, 0, ''], ['44902', '03-02-2026', 0, '00054-26', 12075, 0, ''],
                ['2200', '24-02-2026', 38, '00134-26', 0, 10000, '00134-26'],
                ['1300', '24-02-2026', 0, '00134-26', 1525, 0, ''], ['44902', '24-02-2026', 0, '00134-26', 8475, 0, ''],
            ]],
            ['30-0001', '31-01-2026', [
        ...
        foreach ($nalozi as [$nalogId, $dataKn, $entries]) {
            ...
            // IFRS rejects transactions on the first day of the reporting period
            ...
            try {
                ...
                DB::rollBack();
                Log::error("Demirovic retry2: failed {$nalogId}: {$e->getMessage()}");
            }
        }
        ...
        Log::info("Demirovic retry2: imported {$created}/14 nalozi to entity {$entity->id}");
    }
