...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale, '/alati', {
    title: {
      mk: 'Бесплатни алатки за сметководство — ДДВ, Плата, Камата, Даночен календар',
      sq: 'Mjete falas për kontabilitet — TVSH, Pagë, Kamatë, Kalendar tatimor',
      tr: 'Ücretsiz muhasebe araçları — KDV, Maaş, Faiz, Vergi takvimi',
      en: 'Free Accounting Tools — VAT, Salary, Interest, Tax Calendar',
    },
    description: {
...
const copy = {
  mk: {
    ...
    tools: [
      ...
      {
        icon: 'calculator',
        title: 'Казнена камата',
        desc: 'Пресметајте казнена камата по законска стапка (13,25%). За доцни плаќања, судски пресуди и даночни долгови.',
        href: '/alati/kamaten-kalkulator',
        cta: 'Пресметај камата',
      },
      {
        icon: 'calculator',
        title: 'Данок на добивка',
        desc: 'Пресметајте данок на добивка 10%: признати расходи, непризнати ставки и нето добивка.',
        href: '/alati/danok-dobivka-kalkulator',
        cta: 'Пресметај данок',
      },
      {
        icon: 'salary',
        title: 'Трошоци за регистрација',
        desc: 'Колку чини отворање фирма? ДООЕЛ, ДОО или паушалец — комплетна пресметка на трошоци.',
        href: '/alati/kalkulator-registracija-firma',
        cta: 'Пресметај трошоци',
      },
      {
        icon: 'xml',
        title: 'Даночен календар 2026',
        desc: 'Интерактивен календар со сите рокови: МПИН, ДДВ-04, годишна сметка, данок на добивка.',
        href: '/alati/danocen-kalendar',
        cta: 'Отвори календар',
      },
    ],
  ...
  sq: {
    ...
    tools: [
      ...
      {
        icon: 'calculator',
        title: 'Kamata ndëshkuese',
        desc: 'Llogaritni kamatën ndëshkuese me normën ligjore (13,25%). Për pagesa të vonuara, vendime gjyqësore dhe borxhe tatimore.',
        href: '/alati/kamaten-kalkulator',
        cta: 'Llogarit kamatën',
      },
      {
        icon: 'calculator',
        title: 'Tatimi mbi fitimin',
        desc: 'Llogaritni tatimin mbi fitimin 10%: shpenzime të njohura, zëra të panjohura dhe fitimi neto.',
        href: '/alati/danok-dobivka-kalkulator',
        cta: 'Llogarit tatimin',
      },
      {
        icon: 'salary',
        title: 'Shpenzime regjistrimi',
        desc: 'Sa kushton hapja e firmës? SHPKNJP, SHPK ose paushalist — llogaritja e plotë e shpenzimeve.',
        href: '/alati/kalkulator-registracija-firma',
        cta: 'Llogarit shpenzimet',
      },
      {
        icon: 'xml',
        title: 'Kalendari tatimor 2026',
        desc: 'Kalendar interaktiv me të gjitha afatet: MPIN, DDV-04, llogaria vjetore, tatimi mbi fitimin.',
        href: '/alati/danocen-kalendar',
        cta: 'Hap kalendarin',
      },
    ],
  ...
  tr: {
    ...
    tools: [
      ...
      },
      {
        icon: 'calculator',
        title: 'Ceza faizi',
        desc: 'Yasal oranla (%13,25) ceza faizini hesaplayın. Geç ödemeler, mahkeme kararları ve vergi borçları için.',
        href: '/alati/kamaten-kalkulator',
        cta: 'Faiz hesapla',
      },
      {
        ...
        desc: '%10 kurumlar vergisini hesaplayın: kabul edilen giderler, kabul edilmeyen kalemler ve net kâr.',
        href: '/alati/danok-dobivka-kalkulator',
        cta: 'Vergi hesapla',
      },
      {
        icon: 'salary',
        title: 'Kayıt maliyetleri',
        desc: 'Şirket kurmanın maliyeti ne kadar? DOOEL, DOO veya düz oranlı — tam maliyet hesaplaması.',
        href: '/alati/kalkulator-registracija-firma',
        cta: 'Maliyet hesapla',
      },
      {
        icon: 'xml',
        title: 'Vergi takvimi 2026',
        desc: 'Tüm tarihlerle etkileşimli takvim: MPIN, DDV-04, yıllık hesaplar, kurumlar vergisi.',
        href: '/alati/danocen-kalendar',
        cta: 'Takvimi aç',
      },
    ],
  ...
  en: {
    ...
    tools: [
      ...
      },
      {
        ...
        desc: 'Calculate penalty interest at the statutory rate (13.25%). For late payments, court judgments and tax debts.',
        href: '/alati/kamaten-kalkulator',
      ...
      },
      {
        icon: 'calculator',
        title: 'Corporate Tax',
        desc: 'Calculate 10% corporate tax: recognized expenses, non-deductible items and net profit.',
        href: '/alati/danok-dobivka-kalkulator',
        cta: 'Calculate tax',
      },
      {
        ...
        desc: 'How much does it cost to start a company? DOOEL, DOO or sole trader — complete cost breakdown.',
        href: '/alati/kalkulator-registracija-firma',
        cta: 'Calculate costs',
      },
      {
        ...
        desc: 'Interactive calendar with all deadlines: MPIN, DDV-04, annual accounts, corporate tax.',
        href: '/alati/danocen-kalendar',
        cta: 'Open calendar',
      },
    ],
