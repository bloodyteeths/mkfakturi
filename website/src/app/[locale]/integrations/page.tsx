...
const copy = {
  mk: {
    ...
    categories: {
      ...
      items: [
        ...
        },
        {
          ...
          integrations: ['AI инсајти (GPT-4, Claude, Gemini)', 'OCR скенирање на фактури', 'Интелигентен увоз', 'Фискална сметка DataMatrix', 'AI Асистент (говорни команди)', 'AI Документ Хаб', 'AI Банковно порамнување (Gemini)'],
          extras: [],
        },
      ],
    },
    timeline: {
      ...
      live: { label: 'Активно', items: ['9 банки (CSV/MT940/PDF)', 'Е-Фактура (QES)', 'NBRM курсна листа', 'AI инсајти', 'OCR скенирање', 'AI Асистент', 'AI Документ Хаб', 'AI Порамнување'] },
  ...
  sq: {
    ...
    categories: {
      ...
      items: [
        ...
        },
        {
          ...
          integrations: ['AI insights (GPT-4, Claude, Gemini)', 'OCR skanim faturash', 'Import inteligjent', 'Fiskale DataMatrix', 'Asistent AI (komanda zanore)', 'AI Dokument Hub', 'AI Rekoncilim bankar (Gemini)'],
          extras: [],
        },
      ],
    },
    timeline: {
      ...
      live: { label: 'Aktive', items: ['9 banka (CSV/MT940/PDF)', 'e-Faturë (QES)', 'NBRM kurse', 'AI insights', 'OCR skanim', 'Asistent AI', 'AI Dokument Hub', 'AI Rekoncilim'] },
  ...
  tr: {
    ...
    categories: {
      ...
      items: [
        ...
        },
        {
          ...
          integrations: ['AI içgörüler (GPT-4, Claude, Gemini)', 'OCR fatura tarama', 'Akıllı içe aktarma', 'Mali fiş DataMatrix', 'AI Asistan (sesli komutlar)', 'AI Belge Merkezi', 'AI Banka Mutabakatı (Gemini)'],
          extras: [],
        },
      ],
    },
    timeline: {
      ...
      live: { label: 'Aktif', items: ['9 banka (CSV/MT940/PDF)', 'e-Fatura (QES)', 'NBRM kurları', 'AI içgörüler', 'OCR tarama', 'AI Asistan', 'AI Belge Merkezi', 'AI Mutabakat'] },
  ...
  en: {
    ...
    categories: {
      ...
      items: [
        ...
        },
        {
          ...
          integrations: ['AI insights (GPT-4, Claude, Gemini)', 'OCR invoice scanning', 'Intelligent data import', 'Fiscal receipt DataMatrix', 'AI Assistant (voice commands)', 'AI Document Hub', 'AI Bank Reconciliation (Gemini)'],
          extras: [],
        },
      ],
    },
    timeline: {
      ...
      live: { label: 'Live', items: ['9 banks (CSV/MT940/PDF)', 'e-Invoice (QES)', 'NBRM exchange rates', 'AI insights', 'OCR scanning', 'AI Assistant', 'AI Document Hub', 'AI Reconciliation'] },
...
export default async function IntegrationsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main id="main-content" className="overflow-x-hidden">
      ...
      <PageHero
        image="/assets/images/hero_integrations.png"
        alt="Connected devices - laptop, phone and bank card on clean desk"
