...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale, '/for-accountants', {
    ...
    description: {
      mk: 'AI платформа за сметководители од 1,784 ден/месец. 30 дена бесплатен пробен период. Управувајте со десетици клиенти од едно место.',
      sq: 'Platforme AI per kontabiliste nga 1,784 den/muaj. 30 dite prove falas. Menaxhoni dhjetera kliente nga nje vend.',
      tr: 'Muhasebeciler icin AI platformu 1,784 den/ay\'dan. 30 gun ucretsiz deneme. Onlarca musteriyi tek yerden yonetin.',
      en: 'AI platform for accountants from 1,784 MKD/month. 30-day free trial. Manage dozens of clients from one place.',
    },
  })
}
