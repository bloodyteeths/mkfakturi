...
const message = {
  ...
  tr: 'Facturino, e‑fatura için yapılandırılmış veriler etrafında inşa edildi ve UJP üretim API’si ile QES entegrasyonu açıldığı anda resmî e‑Fatura sistemine bağlanmaya hazır. e‑Fatura zorunlu hâle geldiğinde, Facturino’daki iş akışınız zaten kurulmuş olacak.'
} as const
