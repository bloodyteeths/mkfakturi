  ...
  mk: {
    ...
    steps: [
      {
        ...
        bullets: [
          ...
          'Поврзи банка преку PSD2 — сигурна, регулирана конекција директно од банката.',
      ...
      },
      {
        ...
        bullets: [
          'Увези банкарски изводи автоматски преку PSD2 или рачно (CSV/MT940).',
    ...
    benefits: {
      ...
      items: [
        ...
        ['PSD2 банкарство', 'Директна конекција со банка — без рачен внес.'],
  ...
  sq: {
    ...
    steps: [
      {
        ...
        bullets: [
          ...
          'Lidh bankën përmes PSD2 — lidhje e sigurt dhe e rregulluar direkt nga banka.',
      ...
      },
      {
        ...
        bullets: [
          'Importo ekstrakte bankare automatikisht përmes PSD2 ose manualisht (CSV/MT940).',
    ...
    benefits: {
      ...
      items: [
        ...
        ['Bankimi PSD2', 'Lidhje direkte me bankën — pa futje manuale.'],
  ...
  tr: {
    ...
    steps: [
      {
        ...
        bullets: [
          ...
          'Bankayi PSD2 ile bagla — bankadan dogrudan guvenli ve duzenli baglanti.',
      ...
      },
      {
        ...
        bullets: [
          'Banka ekstrelerini PSD2 ile otomatik veya manuel (CSV/MT940) olarak ice aktar.',
    ...
    benefits: {
      ...
      items: [
        ...
        ['PSD2 bankacilik', 'Banka ile dogrudan baglanti — manuel giris yok.'],
  ...
  en: {
    ...
    steps: [
      {
        ...
        bullets: [
          ...
          'Connect your bank via PSD2 — a secure, regulated connection straight from your bank.',
      ...
      },
      {
        ...
        bullets: [
          'Import bank statements automatically via PSD2 or manually (CSV/MT940).',
    ...
    benefits: {
      ...
      items: [
        ...
        ['PSD2 Banking', 'Direct bank connection — no manual entry.'],
