    ...
    groups: [
      ...
      },
      {
        ...
        features: [
          {
            icon: '\u{1F3E6}',
            title: 'Банкарски увоз',
            description: 'Увезете банкарски изводи во CSV, MT940 или PDF формат и порамнете ги полуавтоматски со фактури.',
            bullets: [
              'CSV/MT940/PDF увоз на изводи',
              'PDF/OCR скенирање на изводи',
