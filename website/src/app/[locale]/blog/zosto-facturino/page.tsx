...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildArticleMetadata(locale, '/blog/zosto-facturino', {
    title: {
    ...
    description: {
      mk: 'Дознајте ги 10-те главни причини зошто македонските бизниси го избираат Facturino: е-Фактура, ДДВ, УЈП извештаи, банкарски увоз и повеќе.',
      en: 'Discover the 10 main reasons why Macedonian businesses choose Facturino: e-Invoice, VAT, UJP reports, bank statement import and more.',
      sq: 'Zbuloni 10 arsyet kryesore pse bizneset maqedonase zgjedhin Facturino: e-Faturë, TVSH, raporte UJP, import bankar dhe më shumë.',
      tr: 'Makedon işletmelerin Facturino\'yu tercih etmesinin 10 ana nedenini keşfedin: e-Fatura, KDV, UJP raporları, banka ekstresi içe aktarma ve daha fazlası.',
    },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Банкарски увоз', desc: 'Увезете ги банковните изводи во Facturino преку CSV, MT940 или PDF формат. Брзо ги увезувате трансакциите, ги препознавате уплатите од клиенти и ги усогласувате со фактурите. PSD2 (Open Banking) поврзување наскоро.' },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Bank Statement Import', desc: 'Import your bank statements into Facturino via CSV, MT940, or PDF format. Quickly import transactions, recognize client payments, and reconcile them with invoices. PSD2 (Open Banking) connection coming soon.' },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Import i ekstrakteve bankare', desc: 'Importoni ekstraktet bankare në Facturino përmes formatit CSV, MT940 ose PDF. Importoni shpejt transaksionet, njihni pagesat e klientëve dhe pajtojini ato me faturat. Lidhja PSD2 (Open Banking) së shpejti.' },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Banka Ekstresi İçe Aktarma', desc: 'Banka ekstrelerinizi CSV, MT940 veya PDF formatında Facturino\'ya aktarın. İşlemleri hızla içe aktarın, müşteri ödemelerini tanıyın ve faturalarla eşleştirin. PSD2 (Açık Bankacılık) bağlantısı yakında.' },
...
export default async function ZostoFacturinoPage({
  ...
  const articleLd = articleJsonLd({
    ...
    datePublished: '2026-02-20',
    tags: ['Facturino', 'invoicing software', 'Macedonia'],
  })

  const breadcrumbLd = breadcrumbJsonLd([
    { name: homeLabel, href: `/${locale}` },
    { name: blogLabel, href: `/${locale}/blog` },
    { name: t.title, href: `/${locale}/blog/zosto-facturino` },
  ])
