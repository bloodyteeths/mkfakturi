    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Бесплатен план на располагање', desc: 'Започнете без финансиски ризик со бесплатниот план кој вклучува до 5 фактури месечно. Идеален за фрилансери и нови бизниси кои сакаат да го тестираат системот пред да се обврзат. Надградете кога сте подготвени, без притисок.' },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Free Plan Available', desc: 'Start with zero financial risk using the free plan that includes up to 5 invoices per month. Ideal for freelancers and new businesses that want to test the system before committing. Upgrade when you are ready, no pressure.' },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Plan falas i disponueshëm', desc: 'Filloni pa rrezik financiar me planin falas që përfshin deri 5 fatura në muaj. Ideal për freelancer-ë dhe biznese të reja që duan ta testojnë sistemin para se të angazhohen. Përmirësoni kur jeni gati, pa presion.' },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { step: 'Ücretsiz Plan Mevcut', desc: 'Ayda 5 faturaya kadar içeren ücretsiz planla sıfır finansal riskle başlayın. Sistemi taahhütte bulunmadan önce test etmek isteyen serbest çalışanlar ve yeni işletmeler için ideal. Hazır olduğunuzda yükseltin, baskı yok.' },
