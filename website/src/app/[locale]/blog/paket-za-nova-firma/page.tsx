  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: null,
        steps: [
          { step: 'Hire your first employee — contract, MPIN, health card', desc: 'For each employee you need: a signed employment contract (minimum gross salary: 38,507 MKD for 2026), MPIN registration within 8 days of starting work, health insurance registration with FZOM, and a health booklet. All contributions are deducted from the gross salary — the employer does not pay additional amounts on top of gross. Facturino automates the entire gross-to-net calculation.' },
          { step: 'Set up payroll — understand gross-to-net calculation', desc: 'From the gross salary, deductions are: pension 18.8%, health 7.5%, unemployment 1.2%, supplementary 0.5% = 28% contributions. Then personal income tax 10% on (gross minus contributions minus personal deduction of 10,932 MKD). Example: gross 40,000 MKD, contributions 11,200, taxable base 17,868, tax 1,787, net 27,013 MKD. Payment deadline: by the 15th of each month. Facturino calculates this automatically.' },
  ...
  sq: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: null,
        steps: [
          { step: 'Punësoni punonjësin e parë — kontratë, MPIN, kartelë shëndetësore', desc: 'Për çdo punonjës ju nevojitet: kontratë pune e nënshkruar (paga minimale bruto: 38.507 MKD për 2026), regjistrim MPIN brenda 8 ditëve nga fillimi i punës, regjistrim për sigurim shëndetësor në FZOM dhe kartelë shëndetësore. Të gjitha kontributet zbriten nga paga bruto — punëdhënësi nuk paguan shuma shtesë mbi bruto. Facturino automatizon gjithë llogaritjen bruto-neto.' },
          { step: 'Vendosni listën e pagave — kuptoni llogaritjen bruto-neto', desc: 'Nga paga bruto zbriten: pension 18,8%, shëndetësi 7,5%, papunësi 1,2%, shtesë 0,5% = 28% kontribute. Pastaj tatimi personal mbi të ardhurat 10% mbi (bruto minus kontribute minus zbritja personale 10.932 MKD). Shembull: bruto 40.000 MKD → kontribute 11.200 → baza tatueshme 17.868 → tatimi 1.787 → neto 27.013 MKD. Afati i pagesës: deri më 15 të çdo muaji. Facturino e bën këtë llogaritje automatikisht.' },
  ...
  tr: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: null,
        steps: [
          { step: 'İlk çalışanınızı işe alın — sözleşme, MPIN, sağlık kartı', desc: 'Her çalışan için şunlar gerekli: imzalı iş sözleşmesi (2026 için asgari brüt maaş: 38.507 MKD), işe başlamadan itibaren 8 gün içinde MPIN kaydı, FZOM\'da sağlık sigortası kaydı ve sağlık cüzdanı. Tüm katkılar brüt maaştan düşülür — işveren brüt üzerine ek ödeme yapmaz. Facturino tüm brüt-net hesaplamasını otomatikleştirir.' },
          { step: 'Bordro kurun — brüt-net hesaplamayı anlayın', desc: 'Brüt maaştan kesintiler: emeklilik %18,8, sağlık %7,5, işsizlik %1,2, ek %0,5 = %28 katkı. Sonra kişisel gelir vergisi %10 (brüt eksi katkılar eksi kişisel indirim 10.932 MKD). Örnek: brüt 40.000 MKD → katkılar 11.200 → matrah 17.868 → vergi 1.787 → net 27.013 MKD. Ödeme tarihi: her ayın 15\'ine kadar. Facturino bunu otomatik hesaplar.' },
