      ...
      <div className="container relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          {t.testimonials?.items.map((item, i) => (
            <div key={i} className={`bg-white/5 backdrop-blur-lg border border-white/10 p-5 md:p-8 rounded-2xl hover:bg-white/10 transition-colors${t.testimonials && i === t.testimonials.items.length - 1 && t.testimonials.items.length % 2 === 1 ? ' md:col-span-2 md:max-w-2xl md:mx-auto' : ''}`}>
              ...
              <blockquote className="text-sm md:text-lg font-medium leading-relaxed mb-4 md:mb-6 text-gray-100">
                &quot;{item.quote}&quot;
              </blockquote>
